...
import CharacterGridList from 'src/components/character-grid-list';
import { CharacterGridList_CharacterFragment, Maybe } from 'src/gql/graphql';
...
function HomePage() {
  return (
    <>
      ...
      >
        <CharacterGridList items={oneCharacter} />
      </Box>
    </>
  );
}
