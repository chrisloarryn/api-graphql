import { GQL_Character } from '@/generated/graphql/index.js';
import { ResponseCharacterFull, ResponseCharacterFullSchema, ResponseCharacterSimple, ResponseCharacterSimpleSchema } from '../responses/character.response.js';
...
function createGQLCharacter(user: Selectable<Character>): GQL_Character {
  /**
...
function toFullResponse(character: Selectable<Character>): ResponseCharacterFull {
  return ResponseCharacterFullSchema.parse(character);
}

function toSimpleResponse(character: Selectable<Character>): ResponseCharacterSimple {
  return ResponseCharacterSimpleSchema.parse(character);
}
